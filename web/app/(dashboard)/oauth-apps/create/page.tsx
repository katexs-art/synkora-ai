...
const PROVIDERS = [
  ...
  },
  {
    ...
    defaultScopes: ['tweet.read', 'tweet.write', 'users.read', 'follows.read', 'follows.write', 'like.read', 'like.write', 'bookmark.read', 'offline.access'],
  ...
  },
  {
    ...
    defaultScopes: ['openid', 'profile', 'email', 'w_member_social', 'w_organization_social', 'r_organization_social'],
  ...
  },
  {
    ...
    defaultScopes: [],
    redirectUri: '',
    setupGuide: 'https://github.com/katexs/katexs/blob/main/docs/integrations/aws-readonly-policy.json',
    supportsOAuth: false,
    supportsApiToken: true,
  ...
  },
  {
    ...
    defaultScopes: [],
    redirectUri: '',
    setupGuide: 'https://github.com/katexs/katexs/blob/main/docs/integrations/gcp-readonly-roles.md',
    supportsOAuth: false,
    supportsApiToken: true,
  ...
  },
  {
    ...
    defaultScopes: [],
    redirectUri: '',
    setupGuide: 'https://github.com/katexs/katexs/blob/main/docs/integrations/azure-readonly-roles.md',
    supportsOAuth: false,
    supportsApiToken: true,
  ...
  },
  {
    ...
    defaultScopes: [],
    redirectUri: '',
    setupGuide: 'https://github.com/katexs/katexs/blob/main/docs/integrations/digitalocean-readonly-token.md',
    supportsOAuth: false,
    supportsApiToken: true,
